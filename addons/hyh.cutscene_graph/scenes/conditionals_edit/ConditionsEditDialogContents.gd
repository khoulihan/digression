...
const Highlighting = preload("../../resources/conditions/Highlighting.gd")
...
const RangeComparison = preload("../../resources/conditions/comparisons/RangeComparison.gd")
const SetComparison = preload("../../resources/conditions/comparisons/SetComparison.gd")
const SingleValueComparison = preload("../../resources/conditions/comparisons/SingleValueComparison.gd")
